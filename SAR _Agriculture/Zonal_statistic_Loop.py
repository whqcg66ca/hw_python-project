...
date_folders = [
    ...
    # Optional: keep only folders that look like YYYYMMDD
...
for date_name in date_folders:
    print("\n====================================")
    print("Processing date folder: {}".format(date_name))
    print("====================================")
    ...
    if not os.path.isdir(out_folder):
        ...
        print("  Created Zonal folder: {}".format(out_folder))
    else:
        print("  Zonal folder already exists: {}".format(out_folder))
