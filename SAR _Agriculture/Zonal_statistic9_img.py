...
# ArcMap may ignore this; keep for compatibility with your style
try:
...
# Set workspace (keep same structure)
arcpy.env.workspace = in_folder

# ============================================================
# CHANGE #1 (minimal): avoid ListRasters() freeze in SNAP .data
# ============================================================
rasters = []
...
# optional: stable order like ListRasters()
rasters.sort()
...
for raster_name in rasters:
    ...
    # ============================================================
    # CHANGE #2 (minimal): skip elevation
    # ============================================================
    ...
    try:
        ...
        # (Also skip for local incidence angle layers to be safe)
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        # Export filtered DBF to Excel (.xls for ArcMap)
        # ----------------------------------------------------
