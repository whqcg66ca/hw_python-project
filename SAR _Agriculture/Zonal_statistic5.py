...
# --- MODIFY THESE PATHS ---
in_folder   = r"H:\7_Sentinel\North2023\20230807"
out_folder  = r"H:\7_Sentinel\North2023\20230807\Zonal"
...
for raster_name in rasters:
    ...
    try:
        ...
        # ----------------------------------------------------
        out_excel = os.path.join(out_folder, base + "_zonal_mean_std.xlsx")  # use xlsx
