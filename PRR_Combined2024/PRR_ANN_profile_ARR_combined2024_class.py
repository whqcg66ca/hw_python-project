...
from sklearn.metrics import root_mean_squared_error, r2_score, accuracy_score, confusion_matrix, cohen_kappa_score
...
# Create a Sequential classification model
...
# Train the model
history = ann_model.fit(x_train, y_train_categorical, epochs=100, batch_size=32, validation_data=(x_test, y_test_categorical), verbose=2)
