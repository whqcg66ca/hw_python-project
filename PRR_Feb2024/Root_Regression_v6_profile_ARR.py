...
# PLS regression model with 30 components
...
# Plot VIP scores
plt.figure()
plt.scatter(waveleth, vipScore, c='k', marker='x')
...
with open('L:\HSI_Root_Rot\Method\pls_model2.pkl', 'rb') as f:
