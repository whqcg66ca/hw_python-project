...
Teget1=glob.glob(r'N:\UAV Data_Lethbridge Projects 2024\Saskatoon UAV Data 2024 (Steve)_Processed\Oat 2024\June 10 2024 (oats 1DAT)_RedEdge-P\4_index\reflectance', recursive = True)
...
for datapath in Teget:
    ...
    add2= searchpath[ind-18:ind+7] # 23BH  23NL
